					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="{{route('opinions.create')}}">Customer Opinions</a></li>
						...
						<div class="hero-text">
							<div class="hero-text-tablecell">
								...
								<div class="hero-btns">
									...
									<a href="{{route('opinions.create')}}" class="bordered-btn">Contact Us</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-10 offset-lg-1 text-center">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								...
								<div class="hero-btns">
									<a href="{{route('homePage')}}" class="boxed-btn">Visit Shop</a>
									<a href="{{route('opinions.create')}}" class="bordered-btn">Contact Us</a>
								</div>
							</div>
						</div>
